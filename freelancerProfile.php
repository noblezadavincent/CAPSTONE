...
<!--Main profile card-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:10px">
			...
			<ul class="list-group">
				<a href="listservice.php" class="list-group-item list-group-item-info">List a Service</a>
	          	<a href="editFreelancer.php" class="list-group-item list-group-item-info">Edit Profile</a>
				<a href="editfreelanceaccounts.php" class="list-group-item list-group-item-info">Accounts</a>
...
<!--
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<div class="panel panel-warning">
			  ...
			  <div class="panel-body"> <a href="servicelistdetails.php">Services</a></div>
			</div>
			<div class="panel panel-warning">
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:10px">
			...
			<div class="panel panel-success1">
			  ...
			  <div class="panel-body"><h4  style="border-color:#97B394;"><?php echo $prof_title; ?></h4></div>
			</div>
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Skills</div>
			  <div class="panel-body"><h4  style="border-color:#97B394;"><?php echo $skills; ?></h4></div>
			</div>
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Profile Summary</div>
			  <div class="panel-body"><h4  style="border-color:#97B394;"><?php echo $profile_sum; ?></h4></div>
			</div>
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Education</div>
			  <div class="panel-body"><h4  style="border-color:#97B394;"><?php echo $education; ?></h4></div>
			</div>
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Experience</div>
			  <div class="panel-body"><h4  style="border-color:#97B394;"><?php echo $experience; ?></h4></div>
			</div>
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Current jobs</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr style="border-color:#97B394;">
                          <td>Job Id</td>
                          <td>Title</td>
                          <td>Employer</td>
                      </tr>
                      ...
                      if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                <input type="hidden" name="jid" value="'.$job_id.'">
                                    ...
                                    <td><input type="submit"  class="btn btn-info1"style="color: white;" value="'.$e_username.'"></td>
                                    <td>'.$timestamp.'</td>
                                    </tr>
                                </form>
                                ';
			...
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;">Previous Works</div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      <tr style="border-color:#97B394;">
                          <td>Job Id</td>
			...
			<div class="panel panel-success1">
			  ...
			  <div class="panel-body"><h4>
				<div class="services">
                <?php 
				$sql = "SELECT * FROM servicelist where username='$username' ORDER BY date DESC";
				$result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    // output data of each row
                    while($row = $result->fetch_assoc()) {
              ...
              </h4><button class="show-more-btn">Load more</button></div>
			</div>
		</div>
...
<!--Social Network Profiles-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:10px">
			...
			<ul class="list-group">
			  <li class="list-group-item" style="font-size:19px;color:#3B579D;"><i class="fab fa-facebook-square"> <?php echo $fb ?></i></li>
