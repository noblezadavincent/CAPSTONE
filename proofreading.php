...
$sql = "SELECT * FROM servicelist WHERE category='Proofreading' ORDER BY date DESC";
$result = $conn->query($sql);

if(isset($_POST["s_title"])){
	$t=$_POST["s_title"];
	$sql = "SELECT * FROM servicelist WHERE category='Proofreading'";
	$result = $conn->query($sql);
}
...
if(isset($_POST["old"])){
	$sql = "SELECT * FROM servicelist  WHERE category='Proofreading' ORDER BY date ASC";
	$result = $conn->query($sql);
}
...
<html>
<head>
	<title>Proofreading Services</title>
	<meta charset="utf-8">
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:5px 5px 5px 5px;margin-top:10px;">
			<div class="panel panel-success1" >
			  <div class="panel-heading"style="background-color:#97B394;color: whitesmoke;text-align:center;"><h3>Proofreading</h3></div>
				...
				<?php
                       ...
                       ?>
                                  ...
                                  <br>
                                            ...
                                            <form action="proofreading.php" method="post">
