...
if(isset($_POST["editEmployer"])){
    ...
    $sql = "UPDATE employer SET Name='$name',email='$email',contact_no='$contactNo', address='$address', gender='$gender', 
    profile_sum='$profile_sum', birthdate='$birthdate', company='$company', photo='$target_file' WHERE username='$username'";
...
<div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color: #41444B;">Section</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <button type="submit" name="editEmployer" class="btn btn-info1 btn-lg">Save changes</button>
                    </div>
                </div>
            </form>
            </div>
