...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:5px">
			<div class="panel panel-success">
			  <div class="panel-heading"style="text-align: center;"><h3>All Services Offered</h3></div>
		...
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:5px">
	        ...
	        <form action="allservices.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info1"style="color: white;">Search by Category</button></center>
				</div>
	        </form>
	        ...
	        <form action="allservices.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info1"style="color: white;">Search by Freelancer</button></center>
				</div>
	        </form>
