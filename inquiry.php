  ...
  <table class="table table-striped">
    ...
    ?>
      ...
      <td><?=$row["create_datetime"]?></td>
           ...
           <?php 
                if($row['status']==1){
                    echo '<td  ><p ><a href="active.php?id='.$row['id'].'&status=0" class="btn btn-danger">On going</a></td>';
                    
                }
                else{
                     echo '<td  ><p><a href="deletemessage.php?id='.$row['id'].'&status=1"  class="btn btn-dangerbtn btn-success">Finished</a></td>';
                }
            ?>
