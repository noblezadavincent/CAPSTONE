...
$sql = "SELECT * FROM servicelist WHERE category='tutorial' ORDER BY date DESC";
...
if(isset($_POST["old"])){
	$sql = "SELECT * FROM servicelist  WHERE category='tutorial' ORDER BY date ASC";
	$result = $conn->query($sql);
}
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:5px 5px 5px 5px;margin-top:10px;">
			<div class="panel panel-success1" >
			  <div class="panel-heading"style="background-color:#97B394;color: whitesmoke;text-align:center;"><h3>Tutorial</h3></div>
