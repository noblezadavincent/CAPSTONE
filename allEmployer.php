...
<html>
<head>
	<title>All student clients</title>
	<meta charset="utf-8">
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:10px">
			<div class="panel panel-success1">
			  <div class="panel-heading" style="background-color:#97B394;color: whitesmoke;text-align:center;"><h3>All student clients</h3></div>
                      ...
                      if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                <input type="hidden" name="e_user" value="'.$e_username.'">
                                    <tr class="hide-item">
                                    <td><input type="submit" class="btn btn-info1"style="color: white;margin: 8px;" value="'.$e_username.'"></td>
                                    <td>'.$Name.'</td>
                                    <td>'.$email.'</td>
                                    <td>'.$company.'</td>
                                    </tr>
