            ...
            <form id="loginForm" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <button type="submit" name="login" class="btn btn-info1"style="color:whitesmoke;">Login</button>
                    </div>
                </div>
            </form>
            Don't have an account yet? <a href="choose.php"   class="btn btn-info">Register</a>
        </div>
