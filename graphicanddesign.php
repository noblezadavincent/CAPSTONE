...
$sql = "SELECT * FROM servicelist WHERE category='Design & Graphics' ORDER BY date DESC";
$result = $conn->query($sql);

if(isset($_POST["s_title"])){
	$t=$_POST["s_title"];
	$sql = "SELECT * FROM servicelist WHERE category='Design & Graphics'";
	$result = $conn->query($sql);
}
...
if(isset($_POST["old"])){
	$sql = "SELECT * FROM servicelist  WHERE category='Design & Graphics' ORDER BY date ASC";
	$result = $conn->query($sql);
}
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:5px 5px 5px 5px;margin-top:10px;">
			<div class="panel panel-success1" >
			  <div class="panel-heading"style="background-color:#97B394;color: whitesmoke;text-align:center;"><h3>Graphic and Design</h3></div>
				...
				<?php
                       ...
                       ?>
                                  ...
                                  <br>
                                            ...
                                            <form action="graphicanddesign.php" method="post">
