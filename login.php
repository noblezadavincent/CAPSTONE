    ...
    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="text-center">
            <a href="index.html" aria-label="Space">
                <img class="mb-3" src="image/adminlogo.png" alt="Logo" width="60" height="60">
            </a>
          </div>
        <div class="text-center mb-4">
            <h1 class="h3 mb-0">USASS ADMIN LOGIN</h1>
        ...
        <div class="text-center mb-3">
            <p class="text-muted">BACK TO MAIN <a href="index.php">PAGE</a></p>
        </div>
       
		
        
        
        <p class="small text-center text-muted mb-0">University of San Agustin Student Service Marketplace</p>
    </form>
</div>
