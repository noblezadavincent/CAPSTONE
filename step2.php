...
<div class="container">
  ...
  <div class="col-md-6 col-md-offset-1"  id="login">
            ...
            <form id="registrationForm" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-4 control-label" style="color: #41444B;">Resume</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color: #41444B;">Certifications</label>
                    <div class="col-sm-5">
                        <input type="file" id="myfile" name="myfile">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color: #41444B;">Grade Point Average (G.P.A.)</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color: #41444B;">Degree / Diploma Earned: </label>
                    <div class="col-sm-5">
                       <input type="file" id="myfile" name="myfile">
 ...
 <div class="form-group">
                    <label class="col-sm-4 control-label"style="color: #41444B;">Regular full-time work?<br>
</label>
                    <div class="col-sm-5">
                        <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"> Yes <br>
                    <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"> No
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label" id=myCheck"style="color: #41444B;">Have you ever applied to / worked for [Our Company] before?<br>
If yes, please explain (include date): </label>
                    <div class="col-sm-5">
                     <input type="checkbox" id="myCheck" name="vehicle1" value="Bike"onclick="myFunction()"> Yes <br>
                    <input type="checkbox" id="myCheck" name="vehicle1" value="Bike"onclick="myFunction()"> No

                    <input type="text" id="text"  class="form-control" style="display:none;margin-top: 5px; margin-bottom: 10px;">
