	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				  <li class="dropdown">
    <a href="viewservices.php"class="dropbtn">Why USASS?</a>
...
<body>
  ...
  <section class="about-us" style="margin-top: -50px;">
       <?php include 'paginationaboutus.php'?>
    <div class="about">
  
      <img src="image/jm.png" class="pic">
      <div class="text">
        <h2>CEO & Founder</h2>
        <h5>Juan Miguel G. Fernandez</span></h5>
          <p><b>Motto:</b> "Don't wait for things to get better. Life will always be complicated. Learn to be happy right now, otherwise, you'll run out of time."</p>
        <div class="data">
       <a href = "mailto: jmfernandez@usa.edu.ph " class="hire">Email Me</a>
        </div>
      </div>
    </div>
