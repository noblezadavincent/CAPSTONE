...
<div class="container">
    ...
    <div class="row">
        ...
        <p><img id="optionalstuff" src="image/search.png"  style="margin-left: 20px;position: relative;width:450px;height:420px;margin-top:150px;float: left;"> </p>
  <div class="col-md-6 col-md-offset-1"  id="login">
            <div class="page-header">
                
                <h2 style="color: #41444B;">Register as Client</h2>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox" style="color: #41444B;">
                            <label>
                                <input type="checkbox" name="usertype" value="student" /> <p style=" margin-right: -20px;">By ticking, you are confirming that you agree to USASS <a href="TAC.php"> Terms </a>and that you have read our  
